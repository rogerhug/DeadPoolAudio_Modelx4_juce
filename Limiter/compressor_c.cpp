...
// Model step function
void compressor_cModelClass::step(double in, double& out)
{
  boolean_T p;
  ...
  if (!ind3) {
    ...
    rtDWork.obj.Threshold = m_Thrshold;
  }
  ...
  if (!ind3) {
    ...
    rtDWork.obj.AttackTime = m_Attack;
  }
  ...
  if (!ind3) {
    ...
    rtDWork.obj.ReleaseTime = m_Release;
  }
  ...
  if (!ind3) {
    ...
    rtDWork.obj.MakeUpGain = m_MakeUp;
  }
