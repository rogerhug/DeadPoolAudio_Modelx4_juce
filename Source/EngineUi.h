...
public:
...

    {
     ...
     //    startTimer(1000);
        ...
        EngineMenuButton.setColour(juce::TextButton::buttonOnColourId, juce::Colours::silver);
        EngineMenuButton.setColour(juce::TextButton::buttonColourId, juce::Colours::white);
        ...
        StepperOnOff.setButtonText("stepper On/Off");
        StepperOnOff.setClickingTogglesState(true);
        StepperOnOff.setColour(juce::TextButton::buttonOnColourId, juce::Colours::silver);
        StepperOnOff.setColour(juce::TextButton::buttonColourId, juce::Colours::white);
        addAndMakeVisible(StepperOnOff);
        StepperOnOff.setLookAndFeel(fxlaf);
        ...
        PatternState.setColour(juce::TextButton::buttonOnColourId, juce::Colours::silver);
        PatternState.setColour(juce::TextButton::buttonColourId, juce::Colours::white);
    ...
    void resized() override
    {
        ...
        playTimeModeCombo.setBounds(10,20,80,20);
        EngineMenuButton.setBounds (10, 45, 100, 20);
        LfoModulationSampel.setBounds(10,70,50,30);
        StepperOnOff.setBounds(60, 70, 50, 30);
        ...
        SampelN1.setBounds (90,20, 160, 20);
