    ...
    //,urls(p.urls)
{
 ...
 audioProcessor.stepperWave.hideMix(0, engineSwitch);
    ...
    MasterMenu.MainMenuButtons[0].onClick = [this] {
    engineSwitch[10] = false;
    ...
    MasterMenu.MainMenuButtons[1].onClick = [this] { //---------------steppper-----------
    ...
    MasterMenu.MainMenuButtons[2].onClick = [this] {//---------------mixer-------------
    ...
    MasterMenu.MainMenuButtons[3].onClick = [this] {//----------------loader-----------
    ...
    MasterMenu.MainMenuButtons[4].onClick = [this] {//----------------midiCc-----------
    ...
    MasterMenu.MainMenuButtons[5].onClick = [this] {//----------------comp-----------
        ...
        sq6.setVisible(false);
        sq7.setVisible(false);
        audioProcessor.stepperWave.hideMix(5, engineSwitch);
    ...
    audioProcessor.stepperWave.CompInitButton.onClick = [this] {
        audioProcessor.stepperWave.init();
    };
   ...
   //*****************************************************EngineSelect*/********************
    //************************************************************************************
    audioProcessor.mainp.SamplerEngineTemp.setValue(0);
    for (int i = 0; i < 7; i++) {
   ...
   //--------------------------- audioProcessor.mainp.MainLfoNr();-------------------------------
    ...
    for (int i = 0; i < 4; i++) {
       ...
       audioProcessor.Ptime.setlfoSelect(sl);

    };
//---------------------------------------------------------------------
       
        audioProcessor.mainp.mainSHCombo.onChange = [this] {
            audioProcessor.Ptime.setMainModSH(audioProcessor.mainp.mainSHCombo.getSelectedItemIndex());
        ...
        audioProcessor.mainp.TimeSlider.onValueChange = [this] {
            audioProcessor.Ptime.setBpm(audioProcessor.mainp.TimeSlider.getValue());

        };

         audioProcessor.mainp.latenceSlider.onValueChange = [this] {
            audioProcessor.Ptime.setlatence(audioProcessor.mainp.latenceSlider.getValue());

        };
        audioProcessor.mainp.TimeComboBox.onChange = [this] {
            audioProcessor.Ptime.setTimes(audioProcessor.mainp.TimeComboBox.getSelectedItemIndex());
            if (audioProcessor.mainp.TimeComboBox.getSelectedItemIndex() == 0) { audioProcessor.mainp.chronofunkt.setVisible(false); }
            if (audioProcessor.mainp.TimeComboBox.getSelectedItemIndex() == 1) { audioProcessor.mainp.chronofunkt.setVisible(false); }
            if (audioProcessor.mainp.TimeComboBox.getSelectedItemIndex() == 2) { audioProcessor.mainp.chronofunkt.setVisible(true); }
        };

        

        audioProcessor.mainp.SeqLenghtSlider.onValueChange = [this] {
            audioProcessor.Ptime.setSequenceLenght(audioProcessor.mainp.SeqLenghtSlider.getValue());
...
//********************************************************************************************
      ...
      //  audioProcessor.Ptime.Setdivide1(audioProcessor.trs.unserialTSPT1(audioProcessor.valueTreeState)[audioProcessor.mainp.MainTriggerPrNr()]);
 ...
 //*****************************************************************   *********************
   ...
   audioProcessor.esp1.playTimeModeCombo.onChange=[this]{
    ...
    audioProcessor.Ptime.setDivides(audioProcessor.esp1.playTimeModeCombo.getSelectedItemIndex(), 0);
   ...
   audioProcessor.esp1.EngineMenuButton.onClick=[this]{
     ...
     audioProcessor.esp1.SampelGate.onValueChange=[this]{
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp1.SampelGate.getValue(),0);
   ...
   // 
    ...
    audioProcessor.urls.getUrl1V()[audioProcessor.sp1.mp.mSampleN].toString(),juce::dontSendNotification);
        ...
        sq1.setWaveNr(audioProcessor.esp1.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 0);
        if (audioProcessor.esp1.SampelN1.isMouseButtonDown()) {
            sq1.serialWaveParas(audioProcessor.valueTreeState, 0);
   ...
   audioProcessor.esp1.WaveSizes_t.onValueChange = [this] {
    ...
    for (int i = 0; i < 4; i++) {
       audioProcessor.esp1.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp1.WaveSizes[3].getToggleState() == true) { espWsize_T[0] = 3; }
  ...
  //  audioProcessor.Ptime.SetRetrigger1(audioProcessor.esp1.LfoRtrModeCombo.getSelectedItemIndex());
   ...
   audioProcessor.esp1.LfoAmp.onValueChange=[this]{
    ...
    //--------------------------------------------------------------------------compressor------------------
   audioProcessor.stepperWave.CompThrsSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[0].getValue(), 0, 0);
   };

   audioProcessor.stepperWave.CompRatioSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[0].getValue(), 0, 1);
   };

   audioProcessor.stepperWave.CompKneeSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[0].getValue(), 0, 2);
   };

   audioProcessor.stepperWave.CompAttackSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[0].getValue(), 0, 3);
   };

   audioProcessor.stepperWave.CompReleaseSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[0].getValue(), 0, 4);
   };

   audioProcessor.stepperWave.CompMakeUpSliders[0].onValueChange = [this]
   {
       audioProcessor.sp1.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[0].getValue());

       audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[0].getValue(), 0, 5);
   };
    ...
    audioProcessor.esp2.SampelGate.onValueChange=[this]{
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp2.SampelGate.getValue(),1);
    ...
    audioProcessor.loadAudioFile(audioProcessor.urls.getUrl2V()[audioProcessor.sp2.mp.mSampleN].toString(), 1);
    if (audioProcessor.esp2.SampelN1.isMouseButtonDown()) {
        sq2.setWaveNr(audioProcessor.esp2.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 1);
        sq2.serialWaveParas(audioProcessor.valueTreeState, 1);
    }
    ...
    audioProcessor.esp2.SpRelease.onValueChange=[this]{
      ...
      for (int i = 0; i < 4; i++) {
          audioProcessor.esp2.WaveSizes[i].onClick = [this] {
              ...
              if (audioProcessor.esp2.WaveSizes[3].getToggleState() == true) { espWsize_T[1] = 3; }
    ...
    audioProcessor.esp2.LfoRtrModeCombo.onChange=[this]{
     ...
     //   audioProcessor.Ptime.SetRetrigger2(audioProcessor.esp2.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //--------------------------------------------------------------------------compressor------------------
    audioProcessor.stepperWave.CompThrsSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[1].getValue(), 1, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[1].getValue(), 1, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[1].getValue(), 1, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[1].getValue(), 1, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[1].getValue(), 1, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[1].onValueChange = [this]
    {
        audioProcessor.sp2.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[1].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[1].getValue(), 1, 5);
    };
    ...
    audioProcessor.esp3.playTimeModeCombo.onChange=[this]{
        audioProcessor.Ptime.setDivides(audioProcessor.esp3.playTimeModeCombo.getSelectedItemIndex(), 2);
    ...
    audioProcessor.esp3.SampelGate.onValueChange=[this]{
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp3.SampelGate.getValue(),2);
    ...
    audioProcessor.esp3.SampelN1.onValueChange=[this]{
        ...
        if (audioProcessor.esp3.SampelN1.isMouseButtonDown()) {
            sq3.setWaveNr(audioProcessor.esp3.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 2);
            sq3.serialWaveParas(audioProcessor.valueTreeState, 2);
        }
    ...
    for (int i = 0; i < 4; i++) {
        audioProcessor.esp3.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp3.WaveSizes[3].getToggleState() == true) { espWsize_T[2] = 3; }
    ...
    audioProcessor.esp3.LfoRtrModeCombo.onChange=[this]{
      ...
      //  audioProcessor.Ptime.SetRetrigger3(audioProcessor.esp3.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //--------------------------------------------------------------------------compressor------------------
    audioProcessor.stepperWave.CompThrsSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[2].getValue(), 2, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[2].getValue(), 2, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[2].getValue(), 2, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[2].getValue(), 2, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[2].getValue(), 2, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[2].onValueChange = [this]
    {
        audioProcessor.sp3.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[2].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[2].getValue(), 2, 5);
    };
    ...
    audioProcessor.esp4.playTimeModeCombo.onChange=[this]{
        audioProcessor.Ptime.setDivides(audioProcessor.esp4.playTimeModeCombo.getSelectedItemIndex(), 3);
    ...
    audioProcessor.esp4.SampelGate.onValueChange=[this]{
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp4.SampelGate.getValue(),3);
    ...
    audioProcessor.esp4.SampelN1.onValueChange=[this]{
        ...
        if (audioProcessor.esp4.SampelN1.isMouseButtonDown()) {
            sq4.setWaveNr(audioProcessor.esp4.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 3);
            sq4.serialWaveParas(audioProcessor.valueTreeState, 3);
        }
    ...
    for (int i = 0; i < 4; i++) {
        audioProcessor.esp4.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp4.WaveSizes[3].getToggleState() == true) { espWsize_T[3] = 3; }
    ...
    audioProcessor.esp4.LfoRtrModeCombo.onChange=[this]{
      ...
      //  audioProcessor.Ptime.SetRetrigger4(audioProcessor.esp4.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //--------------------------------------------------------------------------compressor------------------
    audioProcessor.stepperWave.CompThrsSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[3].getValue(), 3, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[3].getValue(), 3, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[3].getValue(), 3, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[3].getValue(), 3, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[3].getValue(), 3, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[3].onValueChange = [this]
    {
        audioProcessor.sp4.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[3].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[3].getValue(), 3, 5);
    };
    //-------------------Sampler5------------------------------------
    ...
    audioProcessor.esp5.playTimeModeCombo.onChange = [this] {
        audioProcessor.Ptime.setDivides(audioProcessor.esp5.playTimeModeCombo.getSelectedItemIndex(), 4);
    ...
    audioProcessor.esp5.SampelGate.onValueChange = [this] {
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp5.SampelGate.getValue(),4);
    ...
    audioProcessor.esp5.SampelN1.onValueChange = [this] {
        ...
        if (audioProcessor.esp5.SampelN1.isMouseButtonDown()) {
            sq5.setWaveNr(audioProcessor.esp5.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 4);
            sq5.serialWaveParas(audioProcessor.valueTreeState, 4);
        }
    ...
    for (int i = 0; i < 4; i++) {
        audioProcessor.esp5.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp5.WaveSizes[3].getToggleState() == true) { espWsize_T[4] = 3; }
    ...
    audioProcessor.esp5.LfoRtrModeCombo.onChange = [this] {
      ...
      //  audioProcessor.Ptime.SetRetrigger5(audioProcessor.esp5.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //------------------------------------------------------------------------------comp---------------
    audioProcessor.stepperWave.CompThrsSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[4].getValue(), 4, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[4].getValue(), 4, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[4].getValue(), 4, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[4].getValue(), 4, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[4].getValue(), 4, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[4].onValueChange = [this]
    {
        audioProcessor.sp5.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[4].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[4].getValue(), 4, 5);
    };
    //--------------------------------------------------------------------------compressor------------------
    audioProcessor.stepperWave.CompThrsSliders[4].onValueChange = [this]
    {
    ...
    audioProcessor.esp6.playTimeModeCombo.onChange = [this] {
        audioProcessor.Ptime.setDivides(audioProcessor.esp6.playTimeModeCombo.getSelectedItemIndex(), 5);
    ...
    audioProcessor.esp6.SampelGate.onValueChange = [this] {
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp6.SampelGate.getValue(),5);
    ...
    audioProcessor.esp6.SampelN1.onValueChange = [this] {
        ...
        if (audioProcessor.esp6.SampelN1.isMouseButtonDown()) {
            sq6.setWaveNr(audioProcessor.esp6.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 5);
            sq6.serialWaveParas(audioProcessor.valueTreeState, 5);
        }
    ...
    for (int i = 0; i < 4; i++) {
        audioProcessor.esp6.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp6.WaveSizes[3].getToggleState() == true) { espWsize_T[5] = 3; }
    ...
    audioProcessor.esp6.LfoRtrModeCombo.onChange = [this] {
      ...
      //  audioProcessor.Ptime.SetRetrigger6(audioProcessor.esp6.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //--------------------------------------------------------------------------------comp
    audioProcessor.stepperWave.CompThrsSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[5].getValue(), 5, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[5].getValue(), 5, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[5].getValue(), 5, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[5].getValue(), 5, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[5].getValue(), 5, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[5].onValueChange = [this]
    {
        audioProcessor.sp6.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[5].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[5].getValue(), 5, 5);
    };
    //------------------------------------------------------7---------------------------
    ...
    audioProcessor.esp7.playTimeModeCombo.onChange = [this] {
        audioProcessor.Ptime.setDivides(audioProcessor.esp7.playTimeModeCombo.getSelectedItemIndex(), 6);
    ...
    audioProcessor.esp7.SampelGate.onValueChange = [this] {
        ...
        audioProcessor.Ptime.setGate(audioProcessor.esp7.SampelGate.getValue(),6);
    ...
    audioProcessor.esp7.SampelN1.onValueChange = [this] {
        ...
        if (audioProcessor.esp7.SampelN1.isMouseButtonDown()) {
            sq7.setWaveNr(audioProcessor.esp7.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 6);
            sq7.serialWaveParas(audioProcessor.valueTreeState, 6);
        }
    ...
    for (int i = 0; i < 4; i++) {
        audioProcessor.esp7.WaveSizes[i].onClick = [this] {
            ...
            if (audioProcessor.esp7.WaveSizes[3].getToggleState() == true) { espWsize_T[6] = 3; }
    ...
    audioProcessor.esp7.LfoRtrModeCombo.onChange = [this] {
      ...
      //  audioProcessor.Ptime.SetRetrigger7(audioProcessor.esp7.LfoRtrModeCombo.getSelectedItemIndex());
    ...
    //--------------------------------------------------------------------------compressor------------------
    audioProcessor.stepperWave.CompThrsSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setThrs(audioProcessor.stepperWave.CompThrsSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompThrsSliders[6].getValue(), 6, 0);
    };

    audioProcessor.stepperWave.CompRatioSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setRatio(audioProcessor.stepperWave.CompRatioSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompRatioSliders[6].getValue(), 6, 1);
    };

    audioProcessor.stepperWave.CompKneeSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setKnee(audioProcessor.stepperWave.CompKneeSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompKneeSliders[6].getValue(), 6, 2);
    };

    audioProcessor.stepperWave.CompAttackSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setAttack(audioProcessor.stepperWave.CompAttackSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompAttackSliders[6].getValue(), 6, 3);
    };

    audioProcessor.stepperWave.CompReleaseSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setRelease(audioProcessor.stepperWave.CompReleaseSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompReleaseSliders[6].getValue(), 6, 4);
    };

    audioProcessor.stepperWave.CompMakeUpSliders[6].onValueChange = [this]
    {
        audioProcessor.sp7.comp.setMakeUp(audioProcessor.stepperWave.CompMakeUpSliders[6].getValue());

        audioProcessor.stepperWave.serialCompParas(audioProcessor.valueTreeState, audioProcessor.stepperWave.CompMakeUpSliders[6].getValue(), 6, 5);
    };
   ...
   //     audioProcessor.btc->setDry(audioProcessor.mainp.mainBitCrushWed_Dry.getValue());
    ...
    audioProcessor.mainp.mainLimiterGain.onValueChange=[this]{
      ...
      parameters.attachControls(
                                ...
                                ,audioProcessor.mainp.latenceSlider
...
/*
sprintf(dbt, "|para1| %s ||  para2| %i  para3 %i para 4 %i ",
    audioProcessor.stepperWave.readOut()
    ...
    audioProcessor.mainp.timeLabel.setText(audioProcessor.stepperWave.readOut(), juce::dontSendNotification);
    //    audioProcessor.mainp.timeLabel.setText(audioProcessor.stepperWave.getCOut(), juce::dontSendNotification);
    const int engine = audioProcessor.mainp.SamplerEngineTemp.getValue();
    //audioProcessor.stepperWave.steppVunSerial(engine);
...
void NewProjectAudioProcessorEditor::updateTriggerParas() { 
     ...
     sq1.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 0);
     ...
     sq2.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 1);
     ...
     sq3.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 2);
     ...
     sq4.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 3);
     ...
     sq5.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 4);
     ...
     sq6.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 5);
     ...
     sq7.unSerialWaveVolumeParas(audioProcessor.valueTreeState, 6);
     ...
     audioProcessor.stepperWave.setHideColors3(sq3.getTriggers(2), 2, audioProcessor.mainp.MainTriggerPrNr());
     audioProcessor.stepperWave.setHideColors4(sq4.getTriggers(3), 3, audioProcessor.mainp.MainTriggerPrNr());
     audioProcessor.stepperWave.setHideColors4(sq4.getTriggers(4), 4, audioProcessor.mainp.MainTriggerPrNr());
     audioProcessor.stepperWave.setHideColors4(sq4.getTriggers(5), 5, audioProcessor.mainp.MainTriggerPrNr());
     audioProcessor.stepperWave.setHideColors4(sq4.getTriggers(6), 6, audioProcessor.mainp.MainTriggerPrNr());
     ...
     for (int p = 0; p < 10; p++) {
         for (int e = 0; e < 7; e++) {
             for (int c = 0; c < 5; c++) {
                 ...
                 audioProcessor.stepperWave.unSerialStepps(audioProcessor.valueTreeState, e, 0);
                 audioProcessor.stepperWave.unSerialModeStepps(audioProcessor.valueTreeState, e, 0);
                 audioProcessor.stepperWave.unSerialCompParas(audioProcessor.valueTreeState, e, c);
...
void NewProjectAudioProcessorEditor::updateMidiCCParas()
{
    if (audioProcessor.midiCCupdate == 3)
    {
        sq1.setWaveVolumeSt(audioProcessor.esp1.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 0);
        sq1.serialWaveVolumeParas(audioProcessor.valueTreeState, 0);
    ...
    if (audioProcessor.midiCCupdate == 5)
    {
        sq2.setWaveVolumeSt(audioProcessor.esp2.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 1);
        sq2.serialWaveVolumeParas(audioProcessor.valueTreeState, 1);
    ...
    if (audioProcessor.midiCCupdate == 9)
    {
        sq3.setWaveVolumeSt(audioProcessor.esp3.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 2);
        sq3.serialWaveVolumeParas(audioProcessor.valueTreeState, 2);
    ...
    if (audioProcessor.midiCCupdate == 14)
    {
        sq4.setWaveVolumeSt(audioProcessor.esp4.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 3);
        sq4.serialWaveVolumeParas(audioProcessor.valueTreeState, 3);
    ...
    if (audioProcessor.midiCCupdate == 15)
    {
        sq5.setWaveVolumeSt(audioProcessor.esp5.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 4);
        sq5.serialWaveVolumeParas(audioProcessor.valueTreeState, 4);
    ...
    if (audioProcessor.midiCCupdate == 20)
    {
        sq6.setWaveVolumeSt(audioProcessor.esp6.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 5);
        sq6.serialWaveVolumeParas(audioProcessor.valueTreeState, 5);
    ...
    if (audioProcessor.midiCCupdate == 21)
    {
        sq7.setWaveVolumeSt(audioProcessor.esp7.SampelVolume.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 6);
        sq7.serialWaveVolumeParas(audioProcessor.valueTreeState, 6);
    ...
    if (audioProcessor.midiCCupdate == 85)
    {
        sq1.setWaveNr(audioProcessor.esp1.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 0);
        sq1.serialWaveParas(audioProcessor.valueTreeState, 0);
    }
    if (audioProcessor.midiCCupdate == 86)
    {
        sq2.setWaveNr(audioProcessor.esp2.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 1);
        sq2.serialWaveParas(audioProcessor.valueTreeState, 1);
    }
    if (audioProcessor.midiCCupdate == 87)
    {
        sq3.setWaveNr(audioProcessor.esp3.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 2);
        sq3.serialWaveParas(audioProcessor.valueTreeState, 2);
    }
    if (audioProcessor.midiCCupdate == 88)
    {
        sq4.setWaveNr(audioProcessor.esp4.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 3);
        sq4.serialWaveParas(audioProcessor.valueTreeState, 3);
    }
    if (audioProcessor.midiCCupdate == 89)
    {
        sq5.setWaveNr(audioProcessor.esp5.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 4);
        sq5.serialWaveParas(audioProcessor.valueTreeState, 4);
    }
    if (audioProcessor.midiCCupdate == 90)
    {
        sq6.setWaveNr(audioProcessor.esp6.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 5);
        sq6.serialWaveParas(audioProcessor.valueTreeState, 5);
    }

        if (audioProcessor.midiCCupdate == 102)
        {
            sq7.setWaveNr(audioProcessor.esp7.SampelN1.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 6);
            sq7.serialWaveParas(audioProcessor.valueTreeState, 6);
        }
        if (audioProcessor.midiCCupdate == 104)
        {
            sq1.setPitchSt(audioProcessor.esp1.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 0);
            sq1.serialPitchParas(audioProcessor.valueTreeState, 0);
        }
        if (audioProcessor.midiCCupdate == 105)
        {
            sq2.setPitchSt(audioProcessor.esp2.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 1);
            sq2.serialPitchParas(audioProcessor.valueTreeState, 1);
        }
        if (audioProcessor.midiCCupdate == 106)
        {
            sq3.setPitchSt(audioProcessor.esp3.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 2);
            sq3.serialPitchParas(audioProcessor.valueTreeState, 2);
        }
        if (audioProcessor.midiCCupdate == 107)
        {
            sq4.setPitchSt(audioProcessor.esp4.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 3);
            sq4.serialPitchParas(audioProcessor.valueTreeState, 3);
        }
        if (audioProcessor.midiCCupdate == 108)
        {
            sq5.setPitchSt(audioProcessor.esp5.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 4);
            sq5.serialPitchParas(audioProcessor.valueTreeState, 4);
        }
        if (audioProcessor.midiCCupdate == 118)
        {
            sq6.setPitchSt(audioProcessor.esp6.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 5);
            sq6.serialPitchParas(audioProcessor.valueTreeState, 5);
        }
        if (audioProcessor.midiCCupdate == 121)
        {
            sq7.setPitchSt(audioProcessor.esp7.SampelPitch.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 6);
            sq7.serialPitchParas(audioProcessor.valueTreeState, 6);
        }
        ...
        if (audioProcessor.midiCCupdate == 23)
        {
            sq1.setDelayTSt(audioProcessor.esp1.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 0);
            sq1.serialDelayTParas(audioProcessor.valueTreeState, 0);
        }
        if (audioProcessor.midiCCupdate == 24)
        {
            sq2.setDelayTSt(audioProcessor.esp2.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 1);
            sq2.serialDelayTParas(audioProcessor.valueTreeState, 1);
        }
        if (audioProcessor.midiCCupdate == 25)
        {
            sq3.setDelayTSt(audioProcessor.esp3.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 2);
            sq3.serialDelayTParas(audioProcessor.valueTreeState, 2);
        }
        if (audioProcessor.midiCCupdate == 26)
        {
            sq4.setDelayTSt(audioProcessor.esp4.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 3);
            sq4.serialDelayTParas(audioProcessor.valueTreeState, 3);
        }
        if (audioProcessor.midiCCupdate == 27)
        {
            sq5.setDelayTSt(audioProcessor.esp5.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 4);
            sq5.serialDelayTParas(audioProcessor.valueTreeState, 4);
        }
        if (audioProcessor.midiCCupdate == 28)
        {
            sq6.setDelayTSt(audioProcessor.esp6.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 5);
            sq6.serialDelayTParas(audioProcessor.valueTreeState, 5);
        }
        if (audioProcessor.midiCCupdate == 29)
        {
            sq7.setDelayTSt(audioProcessor.esp7.DelayTime.getValue(), audioProcessor.mainp.MainTriggerPrNr(), 6);
            sq7.serialDelayTParas(audioProcessor.valueTreeState, 6);
        }
