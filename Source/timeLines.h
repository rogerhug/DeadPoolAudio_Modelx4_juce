...
public:
    ...
    void prosessTimeSampels( int nFrames, int selectSp);
  ...
  //-----triggerinputs 
    ...
    void triggersOff(int t) { tr1off = t; }
    void TriggerLenght(); 
...
private:
    ...
    std::atomic<int> IcurrentPositionS3;
    std::atomic<int> IcurrentPositionS4;
    std::atomic<int> IcurrentPositionS5;
    std::atomic<int> IcurrentPositionS6;
    std::atomic<int> IcurrentPositionS7;
