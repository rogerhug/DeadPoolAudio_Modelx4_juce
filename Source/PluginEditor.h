...
public:
    ...
    {
       // parameters.detachControls();//---------******##########  not function Vst3
    ...
    void filenameComponentChanged (FilenameComponent* fileComponentThatHasChanged) override
    {
        ...
        if (CurrentEngine == 4) {
            ...
            audioProcessor.esp5.SampleFileLabel.setText(audioProcessor.urls.getUrl4V()[p5].toString(), juce::dontSendNotification);
            audioProcessor.loadAudioFile(f->getLocationToBrowse(), 0);
        }
        if (CurrentEngine == 5) {
            audioProcessor.urls.serial6(audioProcessor.valueTreeState, f->getLocationToBrowse(), p6);
            audioProcessor.esp6.SampleFileLabel.setText(audioProcessor.urls.getUrl4V()[p6].toString(), juce::dontSendNotification);
            audioProcessor.loadAudioFile(f->getLocationToBrowse(), 0);
        }
        if (CurrentEngine == 6) {
            audioProcessor.urls.serial7(audioProcessor.valueTreeState, f->getLocationToBrowse(), p7);
            audioProcessor.esp7.SampleFileLabel.setText(audioProcessor.urls.getUrl4V()[p7].toString(), juce::dontSendNotification);
            audioProcessor.loadAudioFile(f->getLocationToBrowse(), 0);
        }
